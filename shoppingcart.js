...
var shoppingCart = (function() {
    ...
    function saveCart() {
        ...
        sessionStorage.setItem('shoppingCartOder', JSON.stringify(order));
    }

    // Load cart
    function loadCart() {
        cart = JSON.parse(sessionStorage.getItem('shoppingCart'));
        order = JSON.parse(sessionStorage.getItem('shoppingCartOder'));
    }
    ...
    obj.getOrder = function(dataComenzii, status)
    {
        // total, date, status
    ...
    obj.setInvoicingDetails = function(name, email, phone, address, city, county, company, cui)  {
    ...
    obj.setShippingDetails = function (name, email, phone, address, city, county) {
        event.preventDefault();
        order.shipping =
            {
                name:name,
    ...
    obj.setPayment = function(type, cardNo, cardName, month, year, cvv) {
        event.preventDefault();
        order.payment=
            {
                type:type,
    ...
    obj.process = function ()
    {
        ...
        console.log(cart);
        console.log(order);
        alert('Comanda a fost trimisa. Va multumim!')
    }
